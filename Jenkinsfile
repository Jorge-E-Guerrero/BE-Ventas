pipeline {
    ...
    post {
        success {
            mail to: 'guerrero191096@unis.edu.gt', subject:'La build fue exitosa en el pipeline de la branch ${BRANCH_NAME}', body: 'Jenkins Pipeline, Numero de build ${env.BUILD_NUMBER} Prueba'
        }
        failure {
