pipeline {
    ...
    post {
        success {
            mail to: 'jflores@unis.edu.gt', subject:"La build fue exitosa en el pipeline ${env.JOB_NAME}", body: "Jenkins Pipeline ${env.JOB_NAME}, Numero de build ${env.BUILD_NUMBER}, Log disponible en el URL ${env.BUILD_URL}"
        }
        failure {
