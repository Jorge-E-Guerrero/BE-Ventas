pipeline {
    ...
    post {
        ...
        failure {
            mail to: 'guerrero191096@unis.edu.gt', subject:"Ocurrio un fallo en el pipeline de la branch ${env.GIT_BRANCH}", body: "Jenkins Pipeline, Numero de build ${env.BUILD_NUMBER}"
        }
    }
}
